...
ISR(TIMER0_OVF_vect) {
	...
	PORTB |= (1 << PORTB0) | (1 << PORTB1); // Apagamos displays para evitar ghosting
	
	
	PORTD &= 0x80;     // Apagamos los segmentos (PD0-PD6) PERO mantenemos el valor actual de PD7 (el indicador)
